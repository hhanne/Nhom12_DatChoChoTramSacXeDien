...
<head>
    ...
    <title>Đổi mật khẩu - Trạm Sạc EV</title>
    ...
    <style>
        ...
        /* Bảng Lịch sử (CSS này vẫn được giữ lại phòng trường hợp dùng chung) */
        .status-badge {
            padding: 5px 10px;
            border-radius: 20px;
            font-size: 0.8rem;
            ...
            <div class="profile-card">
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    @if (session('status') === 'password-updated')
                        <span class="text-success fw-bold ms-3">Đã đổi mật khẩu thành công!</span>
                    @endif
                </form>
            </div>
            </main>
