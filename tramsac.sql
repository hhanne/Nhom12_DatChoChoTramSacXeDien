...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2025 at 07:15 PM
...
(1, 1, 1, 5, 'Trạm sạc nhanh, nhân viên hỗ trợ tốt', '2025-10-26 00:15:25'),
(2, 2, 2, 4, 'Cổng sạc ổn nhưng hơi khó tìm chỗ đậu', '2025-10-26 00:15:25');
...
INSERT INTO `datcho` (`datcho_id`, `user_id`, `tramsac_id`, `congsac_id`, `thanhtoan_id`, `ngaydat`, `timebatdau`, `timeketthuc`, `trangthai`) VALUES
(1, 1, 1, 1, 1, '2025-10-15', '2025-10-15 08:00:00', '2025-10-15 09:00:00', 'hoanthanh'),
(2, 2, 2, 3, 2, '2025-10-15', '2025-10-15 10:00:00', '2025-10-15 11:30:00', 'dang_sac'),
(3, 3, 3, 2, 3, '2025-10-15', '2025-10-15 08:00:00', '2025-10-15 09:00:00', 'hoanthanh'),
(4, 4, 4, 4, 1, '2025-10-15', '2025-10-15 10:00:00', '2025-10-15 11:30:00', 'dang_sac');
...
(1, 'momo', 50000.00, '2025-10-26 00:15:25', 'thanhcong', 'GD001'),
(2, 'zalopay', 75000.00, '2025-10-26 00:15:25', 'thanhcong', 'GD002'),
(3, 'vnpay', 45000.00, '2025-10-26 00:15:25', 'choxuly', 'GD003');
...
(1, 'Nguyễn Văn Nam', 'Nam', '1995-05-12', 'Lý Thường Kiệt, TP.HCM', '0909123456', 'vannam@gmail.com', 'nam123@', NULL, NULL, '2025-10-26 00:15:25', 'user', 'hoatdong'),
(2, 'Trần Vân Anh', 'Nữ', '1998-08-20', '45 Nguyễn Huệ, Đà Nẵng', '0918123123', 'vananh@gmail.com', 'vananh478@', NULL, NULL, '2025-10-26 00:15:25', 'user', 'hoatdong'),
(3, 'Lê Minh Quân', 'Nam', '1990-02-10', 'Thanh Xuân, Hà Nội', '0909555444', 'quanadmin@gmail.com', 'admin123', NULL, NULL, '2025-10-26 00:15:25', 'admin', 'hoatdong'),
(4, 'Nguyễn Thị Hồng', 'Nữ', '1995-09-09', 'Đường số 1, KCN Tân Bình, Q. Tân Bình, TP.HCM', '0909123456', 'thihong@gmail.com', 'hong123@', NULL, NULL, '2025-10-26 00:15:25', 'user', 'hoatdong');
...
--
ALTER TABLE `datcho`
  MODIFY `datcho_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
