...
<div class="info-box">
    ...
    <p><strong>Cảnh báo:</strong> Hành động xóa khách hàng sẽ xóa tất cả dữ liệu liên quan và không thể hoàn tác. Vui lòng kiểm tra kỹ thông tin trước khi xác nhận.</p>
</div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="detail-group">
                ...
                <div class="detail-value">{{ $user->hoten ?? 'Chưa đặt tên' }}</div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="detail-group">
        ...
        <div class="col-md-6">
            <div class="detail-group">
                ...
                <div class="detail-value">{{ $user->sdt ?? 'N/A' }}</div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="detail-group">
                ...
                <div class="detail-value">{{ $user->diachi ?? 'N/A' }}</div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="detail-group">
                ...
                <div class="detail-value">{{ $user->gioitinh ?? 'N/A' }}</div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="detail-group">
                ...
                <div class="detail-value">{{ $user->ngaysinh ? \Carbon\Carbon::parse($user->ngaysinh)->format('d/m/Y') : 'N/A' }}</div>
            </div>
        </div>
    </div>

    <form action="{{ route('chinhsua.khachhang.destroy', $user->user_id) }}" method="POST" id="deleteCustomerForm">
        @csrf
        @method('DELETE')
